        ...
        <div className={`z-50 flex flex-col w-full   poppin_font `}>
            ...
            <div className='flex justify-between bg-[#3E4095] w-full lg:px-28 md:px-5 px-3 text-white py-3 '>
                ...
                <div className='hidden gap-3 md:flex'>
                    ...
                    <div className='bg-[#EB268F] p-1 flex justify-center items-center lg:w-10 lg:h-10 md:w-8 md:h-8 hover:bg-[#bc4283] hover:cursor-pointer'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path fillRule="evenodd" clipRule="evenodd" d="M12 18C15.3137 18 18 15.3137 18 12C18 8.68629 15.3137 6 12 6C8.68629 6 6 8.68629 6 12C6 15.3137 8.68629 18 12 18ZM12 16C14.2091 16 16 14.2091 16 12C16 9.79086 14.2091 8 12 8C9.79086 8 8 9.79086 8 12C8 14.2091 9.79086 16 12 16Z" fill="white" />
                    ...
                    <div className='bg-[#EB268F] p-1 flex justify-center items-center lg:w-10 lg:h-10 md:w-8 md:h-8 hover:bg-[#bc4283] hover:cursor-pointer'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <g clipPath="url(#clip0_1_1921)">
                                <path fillRule="evenodd" clipRule="evenodd" d="M5.46112 23.4473V7.99898H0.326953V23.4473H5.46112V23.4473ZM2.89458 5.89054C4.68441 5.89054 5.79933 4.70329 5.79933 3.22087C5.76548 1.70549 4.68441 0.551758 2.92814 0.551758C1.17159 0.551805 0.0234375 1.70554 0.0234375 3.22091C0.0234375 4.70334 1.13775 5.89059 2.86078 5.89059L2.89458 5.89054ZM8.30269 23.4473C8.30269 23.4473 8.37005 9.44844 8.30269 7.99902H13.4377V10.2394H13.4036C14.0788 9.18515 15.2952 7.63626 18.0648 7.63626C21.4438 7.63626 23.9765 9.84421 23.9765 14.5894V23.4474H18.8424V15.1829C18.8424 13.1063 18.0995 11.6893 16.241 11.6893C14.8228 11.6893 13.9777 12.6446 13.6065 13.5681C13.4707 13.8967 13.4377 14.3584 13.4377 14.8201V23.4473H8.30269Z" fill="white" />
                            </g>
                            <defs>
            ...
            {/*  */}
            <div className={`flex justify-between px-3 py-3 bg-white lg:px-28 md:px-5 ${scrolling ? "shadow-lg fixed  duration-500 z-50 w-full" : ""}`}>
                <div>
                    <Image src={Logo} alt="Description of your image" className='w-32 lg:w-56 md:w-36' />
                </div>
                ...
                <div className='flex items-center'>
                    <button className='bg-[#3E4095] lg:py-[17px] lg:px-[55px] md:py-[10px] md:px-[35px] uppercase text-white hover:bg-[#31327a] font-medium text-[16px] hidden md:flex'>Book Now</button>
                    <svg onClick={handleNav} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" className='md:hidden'>
                        <path d="M3 18V16H21V18H3ZM3 13V11H21V13H3ZM3 8V6H21V8H3Z" fill="#3E4095" />
                    </svg>
                </div>
            </div>
            ...
            >
                ...
                <div className='flex justify-center w-full'>
                    <Image src={Logo2} alt="Description of your image" className='w-32 lg:w-56 md:w-36' />
                </div>
                ...
                <div className='flex justify-center w-full pb-5 mt-5 border-b-2'>
                    <button className='bg-[#3E4095]  py-[10px]  px-[35px] uppercase text-white hover:bg-[#31327a] font-medium text-[16px]'>Book Now</button>
                </div>
