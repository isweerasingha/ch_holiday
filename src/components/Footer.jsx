      ...
      <div className=" h-full w-full flex flex-col lg:flex-row bg-[#262626] px-3 py-10  lg:px-28 md:px-5 gap-10 lg:gap-6  items-center">
        <div className="flex flex-col w-full gap-5 pr-3 md:pr-12 xl: lg:w-2/6">
          ...
          <p className="text-[16px] text-justify">
            From the vibrant landscapes of Sri Lanka to the allure of global
            destinations, we invite you to embark on a journey with us.
          </p>
        </div>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex gap-5 lg:flex-col xl:text-sm">
                ...
                <div className="flex items-center gap-2">
                  <Image src={Phone} alt="/" />
                  <span>
                    <Link href="tel:+94788755092">+94 78 875 5092</Link>
                  </span>
                </div>
              </div>
