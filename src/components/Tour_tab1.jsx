      ...
      <Fade>
                ...
                <div className="relative">
                  ...
                  <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-t from-[#000000be] to-transparent flex justify-center items-end">
                    <div className="flex flex-col gap-2 px-10 pb-10 text-center text-white md:px-3 lg:px-10">
                      ...
                      <p>
                        Nestled hills, tea plantations, waterfalls, and Nine
                        Arch Bridge.
                      </p>
                    </div>
                  </div>
                ...
                <div className="relative">
                  ...
                  <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-t from-[#000000be] to-transparent flex justify-center items-end">
                    <div className="flex flex-col gap-2 px-10 pb-10 text-center text-white md:px-3 lg:px-10">
                      ...
                      <p>
                        Cultural capital, Temple of the Tooth, Kandy Lake, and
                ...
                <div className="relative">
                  ...
                  <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-t from-[#000000be] to-transparent flex justify-center items-end">
                    <div className="flex flex-col gap-2 px-10 pb-10 text-center text-white md:px-3 lg:px-10">
                      ...
                      <p>
                        UNESCO site, Sigiriya Rock Fortress, ancient city, and
                        mesmerizing frescoes.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="flex flex-col px-3 pt-10 lg:pt-20 lg:px-28 md:px-10">
          ...
          <p className="pt-6 lg:pt-10">
            Begin and conclude in Colombo! You have an 8-day tour package with
            the In-depth Cultural tour Lifetime Experience in Sri Lanka that
            includes travel to Negombo, Sri Lanka, as well as 12 other
            locations. A hotel stay, a professional guide, meals,
            transportation, and other amenities are all included in the Lifetime
        ...
        <div className="flex flex-col px-3 pt-10 lg:pt-20 lg:px-28 md:px-10">
          ...
          <p className="pt-6 lg:pt-10">
            This exclusive 8-day tour is thoughtfully planned to include both
            beach and city time, as well as nature and wildlife, history and
            culture. The cozy hotels and resorts in Sri Lanka will provide you
            with the warm hospitality of the country. Sri Lanka is well-known
            for being a complete travel destination because it has everything a
            traveler could possibly want, including beaches, mountains,
            historical sites, wildlife, and a vibrant local culture. Your tour
            guide, who speaks multiple languages and is well-versed in every
            facet of this amazing nation, will show you around a lot of
            intriguing locations and impart his wisdom on Sri Lankan history and
            customs. We are therefore confident that you will have a fantastic,
            fulfilling vacation and treasured memories that will last a
            lifetime.
          </p>
        </div>
              ...
              >
                <div className="flex items-center gap-5">
                  ...
                  <span className="hidden md:block">
                    Airport or hotel pick-up / Welcome to Sri Lanka!
                  </span>
                </div>
            ...
            >
              <div className="flex flex-col w-full gap-2 px-5 mx-5 border-black md:mx-8 md:px-10 border-s-2">
                ...
                <p className="text-sm text-justify md:text-base">
                  This exclusive 8-day tour is thoughtfully planned to include
                  both beach and city time, as well as nature and wildlife,
                  history and culture. The cozy hotels and resorts in Sri Lanka
                  will provide you with the warm hospitality of the country. Sri
                  Lanka is well-known for being a complete travel destination
                  because it has everything a traveler could possibly want,
                  including beaches, mountains, historical sites, wildlife, and
                  a vibrant local culture. Your tour guide, who speaks multiple
                  languages and is well-versed in every facet of this amazing
                  nation, will show you around a lot of intriguing locations and
                  impart his wisdom on Sri Lankan history and customs. We are
                  therefore confident that you will have a fantastic, fulfilling
                  vacation and treasured memories that will last a lifetime
                </p>
              </div>
            </Collapse>
          </Box>
          ...
          <Box>
            ...
            >
              <div className="flex flex-col w-full gap-2 px-5 mx-5 border-black md:mx-8 md:px-10 border-s-2">
                ...
                <p className="text-sm text-justify md:text-base">
                  The orphanage was originally founded to afford care and
                  protection to the many orphaned Elephants found in the jungles
                  of Sri Lanka. The elephants are taken to the river twice a day
                  for a bath, and all the babies less than three years of age
                  are still bottle-fed by the mahouts and volunteers. The main
                  attraction is clearly to observe the elephants bathing which
                  is quite a spectacle. Entrance Ticket – USD 10 Per Adult
                </p>
