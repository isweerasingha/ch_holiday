    ...
    return (
        <div>
            ...
            <div className='relative w-full'>
                ...
                <div className='absolute top-0 left-0 w-full h-full bg-[#0000004a] flex justify-center items-center text-white'>
                    <div className='flex flex-col gap-1 text-center md:gap-4'>
                        <h1 className='text-xl font-bold md:text-5xl'>Sri Lanka Tour Package</h1>
                        <h1 className='text-xl font-bold md:text-5xl'>3 Days | Private Tour</h1>
                        <div className='flex items-center justify-center gap-2 mt-5 text-sm md:text-xl'>
                            ...
                            <span className='hidden text-sm md:flex'>Sri Lanka Tour Package 3 Days | Private Tour</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className='w-full py-10 lg:pt-20'>
                <Tabs color="#EB268F" variant="pills" radius="xs" defaultValue="Package_Details">
                    <Tabs.List className='px-3 lg:px-28 md:px-10'>
                        <Tabs.Tab value="Package_Details" leftSection={<HiBriefcase style={iconStyle} />} className='bg-[#EB268F] w-full md:w-auto flex justify-start'>
                            Tour Package Details
                        </Tabs.Tab>
                        <Tabs.Tab value="Inclusions_Exclusions" leftSection={<FaArrowUpFromGroundWater style={iconStyle} />} className='bg-[#EB268F] w-full md:w-auto flex justify-start'>
                            Inclusions & Exclusions
                        </Tabs.Tab>
                        <Tabs.Tab value="Hotels_Pricing" leftSection={<FaSackDollar style={iconStyle} />} className='bg-[#EB268F] w-full md:w-auto flex justify-start'>
                            Hotels & Pricing
                        </Tabs.Tab>
                        <Tabs.Tab value="Summery" leftSection={<MdSummarize style={iconStyle} />} className='bg-[#EB268F] w-full md:w-auto flex justify-start'>
                            Summery
                        </Tabs.Tab>
                    </Tabs.List>
