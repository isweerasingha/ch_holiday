      ...
      <div className="grid w-full grid-cols-1 px-3 lg:grid-cols-2 bg2 lg:pr-28 lg:pl-12 md:px-5">
        ...
        <div className="flex flex-col justify-center gap-[34px] lg:py-16 md:py-10 py-5 text-white lg:pl-10">
          ...
          <p className="text-[16px] text-justify">
            ...
            website. Here, we invite you to delve into a world of extraordinary
            destinations and meticulously crafted itineraries that redefine the
            very essence of exploration. Whether you seek cultural immersion,
            natural wonders, or thrilling adventures, our platform is your
            gateway to a diverse tapestry of travel possibilities. Join us in
            discovering the best that global tourism has to offer, and let your
            wanderlust find its perfect match with &apos;Them Best Great
            Tourism.
          </p>
        ...
        <div className="grid w-full grid-cols-1 lg:grid-cols-2">
          <div className="flex flex-col justify-center gap-[34px] lg:py-20 md:py-10 py-5 lg:pr-14 bg-logo">
            ...
            <p className="text-[16px] text-justify">
              ...
              scenery, and adventurous excursions. Plan your visit to dig deeper
              into the exciting locations and make your trip one of the most
              amazing ones. With CH Asian Holidays, you won’t have to worry
              about planning, accommodating and booking, making it easier for
              you to spend every second of your holiday tour in Sri Lanka the
              perfect one!
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="bg-[#ececf4] flex flex-col md:p-8 lg:p-16 p-6 gap-6 justify-between">
              ...
              <p className="text-[16px]">
                ...
                pharetra nunc. Morbi imperdiet dui eu facilisis vestibulum. Sed
                dignissim non nibh auctor finibus. Integer mollis varius.
              </p>
